...
function oddsAndEvens(array) {
  const evenNumArray = array.map(num => {
    if (num %2 === 0){
    console.log('even')
  }
    console.log('odd')
...
let beginsWithB = ['Bell', 'Ball', 'Sandwich', 'Bull', 'Apples']
function beginsWithB(array) {
console.log(
 beginsWithB.filter(function beginsWithB) {
return beginsWithB.startsWith('B') || beginsWithB.startsWith('b')
)
} 
