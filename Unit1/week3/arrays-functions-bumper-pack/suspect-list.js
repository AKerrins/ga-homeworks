...
//
//const bloodTypeA = arr.filter(bloodType ==> bloodType ==="A")
 const murderer = suspects.filter(function (clues) {
  return clues.bloodType === 'A' && clues.height <= 180 && clues.height >= 155 && clues.shoesSize == 12 })
